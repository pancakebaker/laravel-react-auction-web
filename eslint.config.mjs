...
const tsFiles = ['resources/js/**/*.{ts,tsx}'];
const nodeFiles = ['resources/js/**/*.ts'];
const reactFiles = ['resources/js/**/*.{ts,tsx}'];
const testFiles = ['resources/js/**/*.test.{ts,tsx}', 'resources/js/**/test/**/*.{ts,tsx}'];
const productionDocumentationFiles = ['resources/js/**/*.{ts,tsx}'];
